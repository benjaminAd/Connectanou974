    ...
    <div class="d-flex justify-content-center align-items-center divCon mt-5">
        <form class="border border-light p-5 divConnect needs-validation" enctype="multipart/form-data" method="post"
            ...
            <div class="form-group">
                <label>SIRET</label>
            <input type="number" name="siret" class="form-control" id="siret" placeholder="ex : 36252187900034" data-toggle="tooltip" value="<?php echo e(old("siret")); ?>" data-placement="right" title="Évitez les espaces dans le Siret"/>
