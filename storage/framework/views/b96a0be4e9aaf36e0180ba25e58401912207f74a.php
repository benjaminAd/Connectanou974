...
<section class="py-5  mt-5 text-justify">
    ...
    <!-- <img src="<?php echo e(asset('img/landing_por.png')); ?>"  style="align-items: center;" class="col-md-10 col-lg-10 col-sm-10 col-xs-10"><br><br> -->
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <FONT size="4pt">
                ...
                <p>
                Faites <strong>confiance</strong> à la <a href="<?php echo e(url('landingRea')); ?>">jeunesse réunionnaise</a>, vous leur permettez de monter en
                ...
                <p>
                Afin de déposer votre mission, il suffit de vous <a href="<?php echo e(route('PortProjetSub')); ?>">inscrire</a> sur <strong>CONNECTANOU</strong> et
                remplir le formulaire de <a href="<?php echo e(url('annonce')); ?>">dépôt de projet</a>. Vous allez recevoir un mail de validation ou de
                ...
                aider pour la rédaction de votre cahier des charges. N’hésitez pas à nous <a href="<?php echo e(url('contact')); ?>">contacter</a>.
                </p>
            </FONT>
            <p> &nbsp;</p>
            <p> &nbsp;</p>
