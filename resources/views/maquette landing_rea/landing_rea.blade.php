...
<section class="py-5  mt-5 ">
    ...
    <!-- <div class="container-fluid ml-5">
            <img src="{{ asset('img/landing_rea.png')}}" class="col-md-10 col-lg-10 col-sm-10 col-xs-10" style="width: 90%" class="center-block" alt="realisateur de projets"><br><br>
          </div> -->
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                ...
                <div class="container-fluid ml-5">
                    ...
                    <a href="{{{url('landingPor')}}}">petites entreprises</a> ou associations réunionnaises</strong> qui n'ont pas forcément les
                    ...
                    <p>Vous pouvez <a href="{{{url('annonce')}}}">rechercher</a> et parcourir tous les <strong>projets</strong> déposés par les <strong>entrepreneurs</strong>,
                        choisir celui ou ceux qui répondent à vos compétences ou vos valeurs. Par contre, pour entrer en
                    contact et négocier avec le porteur de projet, il faut être <a href="{{{route('SubscribeRea')}}}">inscrit</a> sur
                    ...
                    <p>N’hésitez pas à nous <a href="{{{url('contact')}}}">contacter</a>.</p>
                </FONT>
                <p> &nbsp; </p>
                <p> &nbsp;</p>
                <p> &nbsp;</p>
